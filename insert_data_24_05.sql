...
VALUES
    ...
    ('Jane', 'Smith', 1000, '2004', 'janesmith', 'secret456', 'S'),
    ...
    ('Sarah', 'Wilson', 1000, '1982', 'sarahwilson', 'admin123', 'S'),
    ('Robert', 'Anderson', 1000, '1972', 'robertanderson', 'welcome1', 'T'),
    ('Jennifer', 'Miller', 1000, '1995', 'jennifermiller', 'pass1234', 'S'),
    ('Daniel', 'Taylor', 1000, '2003', 'danieltaylor', '12345678', 'S'),
    ('Michelle', 'Lee', 1000, '2001', 'michellelee', 'password456', 'S');
...
VALUES
    ...
    ('Emily', 'Brown', 1001, '1988', 'emilybrown', 'abc123', 'T'),
    ('David', 'Davis', 1001, '1992', 'daviddavis', 'qwerty', 'T'),
    ('Sarah', 'Wilson', 1001, '1981', 'sarahwilson', 'letmein', 'S'),
    ('Michael', 'Smith', 1001, '1985', 'michaelsmith', 'admin123', 'O'),
    ('Jennifer', 'Miller', 1001, '1979', 'jennifermiller', 'welcome1', 'S'),
    ('Robert', 'Anderson', 1001, '1998', 'robertanderson', 'pass1234', 'S'),
    ('Daniel', 'Taylor', 1001, '2006', 'danieltaylor', '12345678', 'S'),
    ('Michelle', 'Lee', 1001, '2004', 'michellelee', 'password456', 'S');
...
VALUES
    ...
    ('Emma', 'Martinez', 1002, '1991', 'emmamartinez', 'qwerty', 'T'),
    ('Ethan', 'Thomas', 1002, '1984', 'ethanthomas', 'letmein', 'S'),
    ('Isabella', 'Wilson', 1002, '1989', 'isabellawilson', 'admin123', 'O'),
    ('Ava', 'Smith', 1002, '1978', 'avasmith', 'welcome1', 'S'),
    ('Noah', 'Lee', 1002, '1997', 'noahlee', 'pass1234', 'S'),
    ('Liam', 'Taylor', 1002, '2007', 'liamtaylor', '12345678', 'S'),
    ('Mia', 'Rodriguez', 1002, '2004', 'miarodriguez', 'password456', 'S');

#Users - Springfield Middle School (school id = 1003)
INSERT INTO users (user_first_name, user_last_name, school_id, birth_year, myusername, mypassword, user_role)
VALUES
    ('Panagiota', 'Breza', 1003, '2006', 'Giota', 'password123', 'S'),
    ('Emily', 'Miller', 1003, '2005', 'emilymiller', 'secret456', 'S'),
    ...
    ('Ethan', 'Thomas', 1003, '1989', 'ethanthomas', 'admin123', 'T'),
    ('Olivia', 'Clark', 1003, '1977', 'oliviaclark', 'welcome1', 'S'),
    ('Liam', 'Wilson', 1003, '1996', 'liamwilson', 'pass1234', 'S'),
    ('Mason', 'Lee', 1003, '2007', 'masonlee', '12345678', 'S'),
    ('Ava', 'Rodriguez', 1003, '2004', 'avarodriguez', 'password456', 'S');

#Users - Westwood High School  (school id = 1004)
  INSERT INTO users (user_first_name, user_last_name, school_id, birth_year, myusername, mypassword, user_role)
VALUES
    ('Sophia', 'Taylor', 1004, '2003', 'sophiataylor', 'password123', 'S'),
    ('James', 'Johnson', 1004, '1990', 'jamesjohnson', 'secret456', 'S'),
    ('Oliver', 'Davis', 1004, '1987', 'oliverdavis', 'abc123', 'T'),
    ('Amelia', 'Anderson', 1004, '1985', 'ameliaanderson', 'qwerty', 'T'),
    ('Emma', 'Martinez', 1004, '1984', 'emmamartinez', 'letmein', 'O'),
    ('Elijah', 'Brown', 1004, '1986', 'elijahbrown', 'admin123', 'S'),
    ('Ava', 'Smith', 1004, '1979', 'avasmith', 'welcome1', 'T'),
    ('Noah', 'Williams', 1004, '1995', 'noahwilliams', 'pass1234', 'S'),
    ('Mia', 'Jones', 1004, '2006', 'miajones', '12345678', 'S'),
    ('Liam', 'Miller', 1004, '2002', 'liammiller', 'password456', 'S');

#Users - Meadowbrook Elementary (school id = 1005)
INSERT INTO users (user_first_name, user_last_name, school_id, birth_year, myusername, mypassword, user_role)
VALUES
    ('Olivia', 'Thomas', 1005, '2009', 'oliviathomas', 'password123', 'S'),
    ('William', 'Wilson', 1005, '1988', 'williamwilson', 'secret456', 'S'),
    ...
    ('Mia', 'Smith', 1005, '1983', 'miasmith', 'admin123', 'S'),
    ('Liam', 'Davis', 1005, '1980', 'liamdavis', 'welcome1', 'S'),
...
VALUES
    ...
    ('Olivia', 'Clark', 1006, '1987', 'oliviaclark', 'secret456', 'S'),
    ...
    ('William', 'Allen', 1006, '1990', 'williamallen', 'pass1234', 'S'),
    ('Oliver', 'Baker', 1006, '2006', 'oliverbaker', '12345678', 'S'),
    ('Isabella', 'Young', 1006, '2004', 'isabellayoung', 'password456', 'S');

#Users - Riverside High School(school id = 1007)
    INSERT INTO users (user_first_name, user_last_name, school_id, birth_year, myusername, mypassword, user_role)
VALUES
    ('Maria', 'Gratsia', '1007', '2012', 'MaRiA', 'password123', 'S'),
    ('Amelia', 'Mitchell', 1007, '2002', 'ameliamitchell', 'secret456', 'S'),
    ...
    ('Daniel', 'Bennett', 1007, '1992', 'danielbennett', 'welcome1', 'S'),
    ('Emily', 'Hill', 1007, '1995', 'emilyhill', 'pass1234', 'S'),
    ('Logan', 'Reed', 1007, '2003', 'loganreed', '12345678', 'S'),
    ('Sophie', 'Carter', 1007, '2005', 'sophiecarter', 'password456', 'S');
